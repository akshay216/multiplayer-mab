...
sample_count = [[0 for i in range(number_of_channels)] for j in range(number_of_users)]



initiation_test.initiate_assignments(number_of_users, number_of_channels, sample_count, observed_mean, reward_distribution)
time_slots_so_far = number_of_channels


print("Sample Count before CFL:")
for sample in sample_count:
	print(sample)
print()

print("Observed mean before CFL:")
for mean in observed_mean:
	print(mean)
print()


print('Time Slots before CFL:', time_slots_so_far)
print()
...
#assignments, time_slots_so_far = cfl_test.CFL(number_of_channels, number_of_users, time_slots_so_far, sample_count, observed_mean, reward_distribution)
...
print('Time Slots after CFL:', time_slots_so_far)
print()
